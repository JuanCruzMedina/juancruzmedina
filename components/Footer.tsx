    ...
    <footer className="border-t border-[var(--color-border)]">
      <div className="mx-auto max-w-7xl px-6 py-16 md:px-10 md:py-24">
        <div className="grid gap-12 md:grid-cols-3">
          <div>
            <p className="font-display text-2xl tracking-[0.1em] text-[var(--color-accent)] md:text-3xl">
          ...
          <div>
            <p className="text-[10px] font-medium tracking-[0.3em] text-[var(--color-muted)] uppercase">
              Navigation
            </p>

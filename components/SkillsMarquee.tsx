...
export function SkillsMarquee() {
  ...
  return (
    <div className="relative w-full overflow-hidden border-t border-[var(--color-border)] py-10 md:py-14">
      <div
      ...
      <div
        ...
        aria-hidden
      />
      <div className="flex animate-marquee gap-12 whitespace-nowrap md:gap-16">
        {track.map((skill, i) => (
          <span
            key={`${skill}-${i}`}

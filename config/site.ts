    ...
    workExperience: [
      {
        ...
        achievement: "Builds high-throughput backend flows at LATAM scale.",
        techStack: [".NET", "SQL"],
        descriptionItems: [
      ...
      {
        charge: "Software Engineer Founder",
        company: "Prestige Rewards",
        location: "Remote",
        date: "Feb 2024 - Current",
        achievement: "Leads product + engineering execution for loyalty systems.",
      ...
      },
      {
        ...
        achievement: "Raised technical hiring quality through senior-level screenings.",
      ...
      },
      {
        ...
        achievement: "Improved certificate update flow and reduced repetitive manual work.",
      ...
      },
      {
        ...
        date: "2020, 2025",
        achievement: "Migrated desktop workflow to web and increased operational accessibility.",
